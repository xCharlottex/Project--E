 ...
 */
final class Version20220805141811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page_mocktail ADD category_id INT DEFAULT NULL, ADD ingredients LONGTEXT NOT NULL, ADD preparation LONGTEXT NOT NULL, ADD titre VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page_mocktail DROP category_id, DROP ingredients, DROP preparation, DROP titre');
    }
}

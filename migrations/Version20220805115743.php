 ...
 */
final class Version20220805115743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cocktails_ingredients DROP FOREIGN KEY FK_A3A9C4603EC4DCE');
        $this->addSql('ALTER TABLE mocktails_ingredients DROP FOREIGN KEY FK_7066C8D03EC4DCE');
        ...
        $this->addSql('ALTER TABLE cocktails ADD ingredients LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cocktails_ingredients (cocktails_id INT NOT NULL, ingredients_id INT NOT NULL, INDEX IDX_A3A9C46095BBB5D6 (cocktails_id), INDEX IDX_A3A9C4603EC4DCE (ingredients_id), PRIMARY KEY(cocktails_id, ingredients_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE ingredients (id INT AUTO_INCREMENT NOT NULL, ingredients VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, quantite VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE mocktails_category (mocktails_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_56376D327C8A66C8 (mocktails_id), INDEX IDX_56376D3212469DE2 (category_id), PRIMARY KEY(mocktails_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE mocktails_ingredients (mocktails_id INT NOT NULL, ingredients_id INT NOT NULL, INDEX IDX_7066C8D07C8A66C8 (mocktails_id), INDEX IDX_7066C8D03EC4DCE (ingredients_id), PRIMARY KEY(mocktails_id, ingredients_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
